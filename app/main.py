...
async def validate_api_key(request: Request):
    ...
    print(f"Received Authorization header: {authorization}")  # Add this log
    ...
    print(f"Extracted API key: {api_key}")  # Add this log
    print(f"Valid keys: {VALID_API_KEYS}")  # Add this to check loaded keys
